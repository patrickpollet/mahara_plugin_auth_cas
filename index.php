...
// comme cette page est rappelée via le CAS, il peut ne pas y avoir le cookie de session
// donc la session n'était pas lancée ... 
@session_start();
...
if ($USER->is_logged_in()) redirect($wanturl);
...
if (phpCAS::CheckAuthentication()) { // apparemment ne retrouve pas le 'ticket' au 2eme appel ????
...
//pp_error_log("apres la ligne 90",$wantsurl);
